  ...
  return (
    <Card className="relative bg-[#071a3a]/60 border-[#3a91f0]/20 rounded-xl p-8 pl-10 transition-all duration-300 hover:-translate-y-1 hover:border-[#3a91f0]/45 hover:shadow-[0_12px_32px_rgba(0,0,0,0.3)] overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4">
        ...
        <Badge variant="secondary" className="font-mono text-lg text-[#00d4ff] bg-[#00d4ff]/20 p-4 rounded-full mt-2 sm:mt-0 w-fit border border-transparent">
          {exp.period}
        </Badge>
      </div>
      <ul className="list-disc list-inside text-xl text-[#8ab4d8] space-y-3 marker:text-[#00d4ff]">
