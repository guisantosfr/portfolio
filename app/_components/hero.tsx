...
export default function Hero() {
  ...
  return (
    <section className="relative z-10 min-h-[calc(100vh-70px)] flex flex-col justify-center items-center px-6 py-20 text-center">
      <div className="font-mono text-sm font-semibold text-[#00d4ff] tracking-widest uppercase mb-6 flex items-center gap-3 px-5 py-2.5 rounded-full border border-[#00d4ff]/20 bg-[#00d4ff]/10 animate-fade-up delay-200 backdrop-blur-sm shadow-[0_0_15px_rgba(0,212,255,0.15)]">
      ...
      <p className="text-xl md:text-5xl font-normal text-[#8ab4d8] my-4 animate-fade-up delay-300">
        Oi, eu sou
      </p>
      <h1 className="text-4xl md:text-7xl lg:text-[7.5rem] font-bold leading-none text-[#00d4ff] tracking-tight mb-8 animate-fade-up delay-400 relative inline-flex justify-center">
      ...
      <div className="animate-fade-up delay-900">
        <Button
          className="gap-2 p-6 rounded-xl bg-[#1e6fd4] text-white font-bold tracking-wide transition-all hover:bg-[#3a91f0] hover:-translate-y-1 hover:shadow-[0_8px_32px_rgba(30,111,212,0.35)] text-xl"
          onClick={openCV}>
