      ...
      <div className="relative bg-[#0a2756] overflow-hidden group/image">
        {project.images.length > 1 ? (
          <Carousel className="w-full h-full" opts={{ loop: true }}>
            ...
            <CarouselPrevious className="w-12 h-12 absolute left-4 top-1/2 -translate-y-1/2 border-none text-white bg-black/80" />
            <CarouselNext className="w-12 h-12 absolute right-4 top-1/2 -translate-y-1/2 border-none text-white bg-black/80" />
          </Carousel>
        ) : (
