    ...
    <footer className="text-center py-16 px-4">
      ...
      <ul className="list-none my-6 p-0 flex flex-wrap justify-center items-center gap-8 text-4xl">
        <li>
          ...
          <FontAwesomeIcon icon={faWhatsapp} aria-hidden="true" className='mr-2 text-[#1061e3] hover:text-[#19aafe]' title="Whatsapp" />
        ...
        <li>
          <Link href="https://www.linkedin.com/in/guisantosfr" target="_blank">
            <FontAwesomeIcon icon={faLinkedin} aria-hidden="true" className='mr-2 text-[#1061e3] hover:text-[#19aafe]' title="Linkedin"/>
        ...
        <li>
          <Link href="https://www.github.com/guisantosfr" target="_blank">
            <FontAwesomeIcon icon={faGithubSquare} aria-hidden="true" className='mr-2 text-[#1061e3] hover:text-[#19aafe]' title="Github" />
            <span className="sr-only">Github</span>
          </Link>
        </li>

        <li>
          <Link href="mailto:santosgui678@gmail.com" target="_blank">
            <FontAwesomeIcon icon={faEnvelope} aria-hidden="true" className='mr-2 text-[#1061e3] hover:text-[#19aafe]' title="Email" />
